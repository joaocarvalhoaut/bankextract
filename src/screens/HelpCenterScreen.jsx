    ...
    <div className="space-y-6">
      <section className="hero-mesh overflow-hidden rounded-[32px] border border-slate-700 bg-slate-900/60 px-6 py-8 shadow-soft">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-3xl font-bold tracking-tight text-slate-50">Guias praticos para operar o NC Finance com seguranca</h1>
      ...
      <section className="rounded-[28px] border border-slate-700 bg-slate-900/60 p-6 shadow-soft">
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-slate-50">Artigos essenciais</h2>
      ...
      <section className="rounded-[28px] border border-slate-700 bg-slate-900/60 p-6 shadow-soft">
        ...
        <div className="space-y-3">
          {FAQ_ITEMS.map((item) => (
            <article key={item.question} className="rounded-[20px] border border-slate-700 bg-slate-800/40 p-4">
