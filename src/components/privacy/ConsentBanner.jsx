...
export default function ConsentBanner() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-[90] mx-auto max-w-4xl rounded-2xl border border-cyan-500/20 bg-slate-950/90 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl">
